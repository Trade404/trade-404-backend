...
import com.ds.trade404.domain.PaymentOrderStatus;
import com.ds.trade404.modal.PaymentOrder;
import com.ds.trade404.modal.User;
import com.ds.trade404.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentResponse createRazorpayPaymentLink(User user, Long amount, Long orderId) throws RazorpayException {
        ...
        Long scaledAmount = amount * 100;

        try {
            RazorpayClient razorpay = new RazorpayClient(apiKey, apiSecretKey);

            JSONObject paymentLinkRequest = new JSONObject();
            paymentLinkRequest.put("amount", scaledAmount);
            ...
            paymentLinkRequest.put("callback_url", "http://localhost:4040/wallet?order_id=" + orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount, Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("http://localhost:4040/wallet?order_id=" + orderId)
                .setCancelUrl("http://localhost:4040/payment/cancel")
